export default [
  { label: 'DIN', width: 'label', group: true },
  ...
  { name: 'ö', code: 'KC_SCLN', keys: 'ö' },
  { name: 'ä', code: 'KC_QUOT', keys: 'ä' },
  { name: '#', code: 'KC_BSLS', title: '#' },
  { width: 1250 },
  {
    name: 'Enter',
    code: 'KC_ENT',
  ...
  { width: 1250 },
  { name: 'Alt GR', code: 'KC_RALT', width: 1250 },
